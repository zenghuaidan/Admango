...
public class AbstractDBUnitTestCase {
	...
	public static void init() throws Exception {
		...
		properties.load(AbstractDBUnitTestCase.class.getClassLoader().getResourceAsStream("jdbc.properties"));
	...
	protected void backupAllTables() throws Exception {
		...
		//C:\Users\PROGRA~1\AppData\Local\Temp\tables2576018605312980601.xml
